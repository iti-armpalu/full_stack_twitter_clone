...
class LeftBanner extends React.Component {
  ...
  showSearchResultsFunc = () => {
    const inputEl = document.querySelector('.right-banner .input-group')
  ...
  relevantPeople = [
   ...
   // --- RightBanner includes search bar, "What's happening" trending topics and "Who to follow" ---
  render () {
    return (
      <div className="d-flex flex-column right-banner px-2 py-2">
        <div className="mb-3">
